...
public enum QueryType {
    ...
    GET_WEEKLY_SCHEDULE_BY_DATE,
    GET_AVAILABLE_TIMES_BY_DATE,
    GET_CURRENT_AVAILABLE_TIMES,
    ...
    REFERRALS_GIVEN_DATE_INTERVAL_AND_REASON, // DONE
    FOLLOWUP_REFERRALS_GIVEN_DATE_INTERVAL, // DONE
    PATIENTS_WITH_MORE_THAN_N_REFERRALS_IN_GIVEN_DATE_INTERVAL, //
    PATIENTS_GIVEN_REFERENCE, // DONE
    REFERRALS_GIVEN_REASON_AND_DATE_INTERVAL, // DONE
    FUTURE_REFERRALS_GIVEN_REASON, // DONE
    PATIENTS_GIVEN_AGE_INTERVAL, // DONE
